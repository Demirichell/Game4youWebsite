...
import { doc, onSnapshot, setDoc, collection, serverTimestamp, query, orderBy } from "firebase/firestore";
        ...
        <div className="flex items-center border-b-2 border-gray-300 pb-4 pl-4 w-full">
          ...
          <form className="w-full" onSubmit={handleSubmitPost}>
            <div className="flex justify-between items-center">
              ...
              <div className="mx-4"> {image && <img className="h-24" src={image} alt="preview"></img>}</div>
              <div className="mr-4">
        ...
        <div className="flex justify-around items-center pt-4">
          <div className="flex items-center">
            ...
            >
              ...
              <input id="addimg" type="file" style={{ display: "none" }} onChange={handleUpload} />
            </label>
